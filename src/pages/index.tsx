...
export default function Home(): JSX.Element {
  ...
  useEffect(() => {
    ...
    swipePrev?.addEventListener("click", handleClick);

    return () => swipePrev?.removeEventListener("click", handleClick);
  }, [page]);
  useEffect(() => {
    const swipeNext = document.querySelector(".swiper-button-next");

    swipeNext?.addEventListener("click", handleClick);

    return () => swipeNext?.removeEventListener("click", handleClick);
  }, [page]);
